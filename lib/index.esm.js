...
var Tooltip = function (props) {
    var _a = useState("black"), textColor = _a[0], setTextColor = _a[1];
    var _b = useState("block"), cross = _b[0], setCross = _b[1];
    var _c = useState("none"), cross1 = _c[0], setCross1 = _c[1];
    useEffect(function () {
    ...
    return (React__default.createElement("div", { style: { display: cross } },
        React__default.createElement("div", { className: props.varient },
            React__default.createElement("div", __assign({ className: props.Success
                    ? "Success7"
                    : props.Information
                        ? "Information7"
                        : "error7" }, props),
                React__default.createElement("h6", { style: {
                        fontSize: "12px",
                        color: props.Genral ? "white" : textColor,
                    } }, props.label),
                React__default.createElement("div", { className: "cross", onClick: function () { return setCross("none"); } },
                    React__default.createElement(default_1, { style: {
                            display: cross1, cursor: "pointer",
                            color: props.Genral ? "white" : textColor,
                        } }))),
            React__default.createElement("h6", { className: "para_div" }, props.paragraph))));
};
